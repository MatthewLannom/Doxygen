 ...
 * 
 * A program that displays information about an employee, officer, and supervisor
 */
...
/**
 * Calls the methods print, calculatePay, and anniversary
 *
 * @param Employee & e An employee, officer, or supervisor 
 * @pre 
 * @return void 
 * @post All tests have been run; information has been printed to the screen
 * 
 */
